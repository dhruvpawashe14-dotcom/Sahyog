...
export const CLAIM_FIELD_CONFIG = {
  Health: [
    ...
    { label: 'RE Name', field: 're_name', target: 'details', type: 'text' },
    { label: 'RM Name', field: 'rm_name', target: 'details', type: 'text' },
    ...
    { label: 'Claim File Received Date', field: 'claim_file_received_date', target: 'details', type: 'date' },
